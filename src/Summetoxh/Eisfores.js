const Eisfores = () => {
    ...
    <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
        <div class="flex-1 p-4 rounded-lg shadow-md border border-blue-400">
            ...
            <p class="text-left text-gray-700 ">Κάθε μέλος υποχρεούται να καταβάλλει στο Ταμείο την εισφορά για κάθε ημερολογιακό μήνα. Το ποσό της μηνιαίας εισφοράς δεν μπορεί να είναι κατώτερο από 30€ ούτε ανώτερο από 500€.</p>
        </div>
        <div class="flex-1 p-4 rounded-lg shadow-md border border-blue-400">
            <p class="text-left text-gray-700">Κάθε μέλος επιλέγει το ποσό της μηνιαίας εισφοράς που καταβάλλει στο Ταμείο μεταξύ του ως άνω κατώτατου και ανώτατου ποσού μηνιαίας εισφοράς.</p>
        </div>
        <div class="flex-1 p-4 rounded-lg shadow-md border border-blue-400">
            
            <p class="text-left text-gray-700">Το δικαίωμα επιλογής του ποσού της εισφοράς ασκείται με έγγραφη δήλωση του μέλους που υποβάλλεται στο Διοικητικό Συμβούλιο του Ταμείου μαζί με την αίτηση εγγραφής του σε αυτό.</p>
        </div>
    </div>
    <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mt-4">
        <div class="flex-1 p-4 rounded-lg shadow-md border border-blue-400">
            
            <p class="text-left text-gray-700">Κάθε μέλος έχει το δικαίωμα να μεταβάλλει το ύψος της μηνιαίας εισφοράς που καταβάλλει στο Ταμείο, υπό τον περιορισμό του ισχύοντος κατώτατου και ανώτατου ποσού εισφορών. <span className="text-blue-500 hover:text-blue-700 underline"><a href="https://www.teaapl.gr/images/pdf/aitisi_metavolis_posou_miniaias_eisforas.pdf" target="_blank"><i class="fa-solid fa-circle-down"></i>Κατεβάστε εδώ το σχετικό έντυπο.</a></span></p>
        </div>
        <div class="flex-1 p-4 rounded-lg shadow-md border border-blue-400">
            
            <p class="text-left text-gray-700">Το δικαίωμα μεταβολής του ύψους της εισφοράς ασκείται μια φορά ανά ημερολογιακό έτος με έγγραφη δήλωση του μέλους, η οποία υποβάλλεται στο Διοικητικό Συμβούλιο του Ταμείου έως την 30η Οκτωβρίου. Η μεταβολή ισχύει από την 1η Ιανουαρίου του επόμενου έτους.</p>
        </div>
        <div class="flex-1 p-4 rounded-lg shadow-md border border-blue-400">
            
            <p class="text-left text-gray-700">Οι εισφορές των μελών κατανέμονται από το Ταμείο στους κλάδους Εφάπαξ και Αλληλεγγύης ανεξάρτητα από το ποσό της μηνιαίας εισφοράς. Στον κλάδο Αλληλεγγύης μεταφέρεται μόνο το ποσό των 4,5€, αφού αφαιρεθεί 6% για λειτουργικά έξοδα και με το υπόλοιπο ποσό δημιουργείται ο ατομικός λογαριασμός του μέλους.</p>
        </div>
    </div>
