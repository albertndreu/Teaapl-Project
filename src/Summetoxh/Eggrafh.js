...
<h1 className="text-center text-2xl underline font-bold text-customBlue mt-20">ΕΓΓΡΑΦΗ</h1>
{/*<section className="mx-auto bg-white shadow-md rounded-lg  p-4 grid lg:grid-cols-2 lg:gap-8 ">
    
    <div className="bg-white text-gray-700 p-6 rounded-lg shadow-md mt-10 hover:text-white hover:bg-customBlue shadow-lg transition delay-50 duration-300 ease-in-out hover:scale-105 transform">
    ...
    <div className="bg-white text-gray-700 p-6 rounded-lg shadow-md mt-10 hover:text-white hover:bg-customBlue shadow-lg transition delay-50 duration-300 ease-in-out hover:scale-105 transform">
        <p className="text-left text-xl  ">
            <span className="text-gray-700">Β)</span>Η ασφάλιση στο Ταμείο είναι προαιρετική και συμπεριλαμβάνει την ένταξη τόσο στον Κλάδο Εφάπαξ όσο και στον Κλάδο Αλληλεγγύης, πλην των ευρισκομένων σε κατάσταση μόνιμης Πολεμικής Διαθεσιμότητας προ της εγγραφής τους στο ταμείο οι οποίοι ασφαλίζονται αποκλειστικά και μόνο στον κλάδο εφάπαξ για όσο διάστημα βρίσκονται σε κατάσταση πολεμικής διαθεσιμότητας.
        </p>
    </div>
    <div className="bg-white text-gray-700 p-6 rounded-lg shadow-md mt-10 hover:text-white hover:bg-customBlue shadow-lg transition delay-50 duration-300 ease-in-out hover:scale-105 transform">
        <p className="text-left text-xl   mb-10 ">
            <span className="text-gray-700">Γ)</span> Για την υπαγωγή των αιτούντων στην ασφάλιση του Ταμείου αποφασίζει το ΔΣ και καθορίζεται δια αυτής και η ημερομηνία έναρξης της εγκρινόμενης ασφάλισης η οποία συμπίπτει με την ημερομηνία της έναρξης καταβολής εισφορών στο Ταμείο.
        </p>
    </div>
    <div class="bg-white text-gray-700 p-6 rounded-lg shadow-md mt-10 hover:text-white hover:bg-customBlue shadow-lg transition delay-50 duration-300 ease-in-out hover:scale-105 transform">
    <p class="text-left text-xl  mb-10">
        <h1 class="underline">Δ) Το υποψήφιο μέλος υποβάλλει για την εγγραφή του στο Ταμείο <span class="text-blue-500 hover:text-white hover:bg-blue-900"><a href="https://www.teaapl.gr/images/pdf/aitisi_eggrafis_melous_apografiko_deltio.pdf" target="_blank">σχετική αίτηση</a></span> υπογεγραμμένη:</h1>
        <ul class="list-disc pl-6 mt-3 space-y-2">
            <li>μέσω της <span class="text-blue-500 hover:text-white hover:bg-blue-900 underline"><a href="https://www.teaapl.gr/images/pdf/aitisi_eggrafis_melous_apografiko_deltio.pdf" target="_blank">ηλεκτρονικής φόρμας εγγραφής</a></span></li>
            <li>μέσω του τοπικού αντιπροσώπου <span class="text-blue-500 hover:text-white hover:bg-blue-900 underline"><a href="/Antiprosopoi"> (πίνακας αντιπροσώπων)</a></span></li>
            <li>με fax στο 210-5248397,</li>
            <li>με e-mail στο <span class="text-blue-500 hover:text-white hover:bg-blue-900 underline"><a href="mailto:info@teaapl.gr">info@teaapl.gr</a></span></li>
    ...
    <div className="bg-white text-customBlue p-6 rounded-lg shadow-md mt-10 hover:text-white hover:bg-customBlue shadow-lg transition delay-50 duration-300 ease-in-out hover:scale-105 transform">
        <p className="text-left text-xl    mb-10 ">
        <h1 className="underline text-gray-700">Ε) Λοιπά έντυπα αιτήσεων:</h1>
        <ul className="list-disc pl-6 mt-3 space-y-2">    
        <li className=" underline"><a href="https://www.teaapl.gr/images/pdf/4)%20%CE%91%CE%AF%CF%84%CE%B7%CF%83%CE%B7%20%CE%B1%CE%BB%CE%BB%CE%B1%CE%B3%CE%AE%CF%82%20%CE%B4%CE%B9%CE%BA%CE%B1%CE%B9%CE%BF%CF%8D%CF%87%CF%89%CE%BD.pdf" target="_blank"><i class="fa-solid fa-link"></i>Αίτηση αλλαγής δικαιούχων</a></li>
        <li className=" underline"><a href="https://www.teaapl.gr/images/pdf/5)%20%CE%91%CE%AF%CF%84%CE%B7%CF%83%CE%B7%20%CE%B5%CF%80%CE%B1%CE%BD%CE%B5%CE%B3%CE%B3%CF%81%CE%B1%CF%86%CE%AE%CF%82%20%CE%BC%CE%AD%CE%BB%CE%BF%CF%85%CF%82%20%CF%80%CE%BF%CF%85%20%CE%AD%CF%87%CE%B5%CE%B9%20%CE%B4%CE%B9%CE%B1%CE%B3%CF%81%CE%B1%CF%86%CE%B5%CE%AF%20(%CF%87%CF%89%CF%81%CE%AF%CF%82%20%CE%BB%CE%AE%CF%88%CE%B7%20%CE%91%CF%84%CE%BF%CE%BC.%20%CE%9C%CE%B5%CF%81%CE%AF%CE%B4....pdf" target="_blank"><i class="fa-solid fa-link"></i>Αίτηση επανεγγραφής μέλους που έχει διαγραφεί</a></li>
        <li className=" underline"><a href="https://www.teaapl.gr/images/pdf/6)%20%CE%91%CF%80%CE%BF%CE%B3%CF%81%CE%B1%CF%86%CE%B9%CE%BA%CF%8C%20%CE%B4%CE%B5%CE%BB%CF%84%CE%AF%CE%BF%20-%20%CE%B5%CF%80%CE%B9%CE%BA%CE%B1%CE%B9%CF%81%CE%BF%CF%80%CE%BF%CE%AF%CE%B7%CF%83%CE%B7%20%CF%83%CF%84%CE%BF%CE%B9%CF%87%CE%B5%CE%AF%CF%89%CE%BD.pdf" target="_blank"><i class="fa-solid fa-link"></i>Απογραφικό δελτίο - επικαιροποίηση στοιχείων</a></li>
        <li className=" underline"><a href="https://www.teaapl.gr/images/pdf/%CE%91%CE%AF%CF%84%CE%B7%CF%83%CE%B7%20%CE%B5%CE%BD%CE%B7%CE%BC%CE%AD%CF%81%CF%89%CF%83%CE%B7%CF%82%20%CE%BC%CE%AD%CE%BB%CE%BF%CF%85%CF%82.pdf" target="_blank"><i class="fa-solid fa-link"></i>Αίτηση ενημέρωσης μέλους</a></li>
        </ul>
        </p>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 ml-5 mr-5">
        ...
        <h1 className="underline text-gray-700">Ε) Λοιπά έντυπα αιτήσεων:</h1>
        <ul className="list-disc pl-6 mt-3 space-y-2">    
        <li className=" underline text-blue-600 hover:text-blue-900"><a href="https://www.teaapl.gr/images/pdf/4)%20%CE%91%CE%AF%CF%84%CE%B7%CF%83%CE%B7%20%CE%B1%CE%BB%CE%BB%CE%B1%CE%B3%CE%AE%CF%82%20%CE%B4%CE%B9%CE%BA%CE%B1%CE%B9%CE%BF%CF%8D%CF%87%CF%89%CE%BD.pdf" target="_blank"><i class="fa-solid fa-link"></i>Αίτηση αλλαγής δικαιούχων</a></li>
        <li className=" underline text-blue-600 hover:text-blue-900"><a href="https://www.teaapl.gr/images/pdf/5)%20%CE%91%CE%AF%CF%84%CE%B7%CF%83%CE%B7%20%CE%B5%CF%80%CE%B1%CE%BD%CE%B5%CE%B3%CE%B3%CF%81%CE%B1%CF%86%CE%AE%CF%82%20%CE%BC%CE%AD%CE%BB%CE%BF%CF%85%CF%82%20%CF%80%CE%BF%CF%85%20%CE%AD%CF%87%CE%B5%CE%B9%20%CE%B4%CE%B9%CE%B1%CE%B3%CF%81%CE%B1%CF%86%CE%B5%CE%AF%20(%CF%87%CF%89%CF%81%CE%AF%CF%82%20%CE%BB%CE%AE%CF%88%CE%B7%20%CE%91%CF%84%CE%BF%CE%BC.%20%CE%9C%CE%B5%CF%81%CE%AF%CE%B4....pdf" target="_blank"><i class="fa-solid fa-link"></i>Αίτηση επανεγγραφής μέλους που έχει διαγραφεί</a></li>
        <li className=" underline text-blue-600 hover:text-blue-900"><a href="https://www.teaapl.gr/images/pdf/6)%20%CE%91%CF%80%CE%BF%CE%B3%CF%81%CE%B1%CF%86%CE%B9%CE%BA%CF%8C%20%CE%B4%CE%B5%CE%BB%CF%84%CE%AF%CE%BF%20-%20%CE%B5%CF%80%CE%B9%CE%BA%CE%B1%CE%B9%CF%81%CE%BF%CF%80%CE%BF%CE%AF%CE%B7%CF%83%CE%B7%20%CF%83%CF%84%CE%BF%CE%B9%CF%87%CE%B5%CE%AF%CF%89%CE%BD.pdf" target="_blank"><i class="fa-solid fa-link"></i>Απογραφικό δελτίο - επικαιροποίηση στοιχείων</a></li>
        <li className=" underline text-blue-600 hover:text-blue-900"><a href="https://www.teaapl.gr/images/pdf/%CE%91%CE%AF%CF%84%CE%B7%CF%83%CE%B7%20%CE%B5%CE%BD%CE%B7%CE%BC%CE%AD%CF%81%CF%89%CF%83%CE%B7%CF%82%20%CE%BC%CE%AD%CE%BB%CE%BF%CF%85%CF%82.pdf" target="_blank"><i class="fa-solid fa-link"></i>Αίτηση ενημέρωσης μέλους</a></li>
        </ul>
        </p>
        </div>
    </div>
