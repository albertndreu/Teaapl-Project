                ...
                <tbody className="w-95 max-h-[calc(89%-0.8rem)] bg-white-50 m-2 rounded-lg overflow-auto border border-gray-300 py-2 px-4">
                    <tr className="border-b hover:bg-customBlue hover:text-white">
                        ...
                        <td><a href="https://www.teaapl.gr/images/pdf/nomothesia/2002%20%CE%A6%CE%95%CE%9A%20160%20%CE%91%2011_07_2002_%CE%9D%203029%20%CE%91%CE%A1%CE%98%CE%A1%CE%91%2007%20%CE%BA%CE%B1%CE%B9%2008.pdf" target="_blank">
                            <a target="_blank" href="https://icons8.com/icon/l0vjMqIboTRs/pdf"></a><img src={PDF} className="lg:w-20 lg:h-10 md:w-32 md:h-6 sm:w-40 sm:h-10"></img><a target="_blank" href="https://icons8.com"></a>
                            </a></td>
                    </tr>
                    <tr className="border-b hover:bg-customBlue hover:text-white">
                        <td className="text-left">
                        ...
                        <td>
                            ...
                            <a target="_blank" href="https://icons8.com/icon/l0vjMqIboTRs/pdf"></a><img src={PDF} className="lg:w-20 lg:h-10 md:w-32 md:h-6 sm:w-40 sm:h-10 xs:w-40 xs:h-2"></img><a target="_blank" href="https://icons8.com"></a>
                            </a>
                        </td>
                    </tr>
                    <tr className="border-b hover:bg-customBlue hover:text-white">
